...
%% desired bounding boxes

% figure; % wrong attempt because function do nit have the final variable
% imshow(final);
% title('desired bounding boxes');
% for idx = 1 : size(takethisbox,1) 
%     rectangle('Position', takethisbox(idx,:), 'edgecolor', 'green');
% end
%% we check the uniquness of X coordinate(character mix with each other or not)
