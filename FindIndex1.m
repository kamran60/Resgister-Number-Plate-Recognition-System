...
elseif isempty(ind) || length(ind)>1 % If there is no vlaue of '6' in the Q vector.
    ...
    if length(ind2)==1
        ...
        container=guessing1(A,B,(B(2)-B(1))); % Call of function guessing1.
        if ~isempty(container) % If guessing1 works succesfully.
            r=takeboxes(NR,container,1); % Call the function takeboxes.
        elseif isempty(container)
            container2=guessing1(E,R,(R(2)-R(1)));
